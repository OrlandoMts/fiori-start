		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices App",
									"targetURL": "#omontesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"omontesinvoices-display": {
								"semanticObject": "omontesinvoices",
								"action": "display",
								"description": "Invoices App an SAP Fiori application.",
								"title": "Invoices App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=omontes.invoices",
									"url": sap.ui.require.toUrl("omontes/invoices")
								}
							}
						}
					}
